...
ActiveRecord::Schema[8.1].define(version: 2026_05_29_170000) do
  create_table "access_tokens", force: :cascade do |t|
    ...
    t.check_constraint "length(token_last_eight) = 8", name: "access_tokens_last_eight_length"
  end
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.integer "sandbox_customer_id", null: false
    ...
    t.check_constraint "account_type IN ('checking', 'savings', 'payment')", name: "accounts_type_valid"
    t.check_constraint "available_balance_cents >= 0", name: "accounts_balance_non_negative"
    t.check_constraint "status IN ('active', 'blocked', 'closed')", name: "accounts_status_valid"
  end
  ...
  create_table "consents", force: :cascade do |t|
    ...
    t.check_constraint "status IN ('awaiting_authorization', 'authorized', 'revoked', 'expired', 'rejected')", name: "consents_status_valid"
  end
  ...
  create_table "developer_apps", force: :cascade do |t|
    ...
    t.check_constraint "status IN ('active', 'suspended')", name: "developer_apps_status_valid"
  end
  ...
  create_table "ledger_transactions", force: :cascade do |t|
    ...
    t.check_constraint "transaction_type IN ('credit', 'debit')", name: "ledger_transactions_type_valid"
  end
  ...
  create_table "payment_initiations", force: :cascade do |t|
    ...
    t.check_constraint "status IN ('accepted', 'rejected', 'settled')", name: "payment_initiations_status_valid"
  end
  ...
  create_table "sandbox_scenarios", force: :cascade do |t|
    ...
    t.check_constraint "status IN ('active', 'retired')", name: "sandbox_scenarios_status_valid"
  end
  ...
  create_table "webhook_deliveries", force: :cascade do |t|
    ...
    t.check_constraint "status IN ('pending', 'delivered', 'failed', 'dead')", name: "webhook_deliveries_status_valid"
  end
